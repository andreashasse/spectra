...
to_inline_schema(TypeInfo, {type, Name, Arity}, Config) ->
    ...
    case spectra_codec:try_codec_schema(TypeInfo, Module, json_schema, TypeRef, Type, Config) of
...
to_inline_schema(TypeInfo, {record, RecordName}, Config) ->
    ...
    Module = spectra_type_info:get_module(TypeInfo),
    case spectra_codec:try_codec_schema(TypeInfo, Module, json_schema, TypeRef, Record, Config) of
